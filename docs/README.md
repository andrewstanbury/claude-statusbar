...
A small standalone tool. The [main README](../README.md) covers install / configure / uninstall — start there.

These docs supplement the README with deeper reference and explanation. They follow the [Diátaxis](https://diataxis.fr/) documentation convention (`reference/`, `explanation/`, `how-to/`), scaled down to fit a small tool:
...
[`../AGENTS.md`](../AGENTS.md) is the entry point for AI agents working on this repo.
